...
class Logger(object):
    ...
    def __enter__(self):
        ...
        fieldnames = ['episode', 'timestep', 'reward', 'win_prob_1', 'win_prob_2', 'win_prob_3']
    ...
    def log_performance(self, episode, timestep, reward, win_prob):
        ...
        self.writer.writerow(
            {'episode':episode,'timestep': timestep, 'reward': reward, 'win_prob_1': str(win_prob[0]), 'win_prob_2': str(win_prob[1]),
             'win_prob_3': str(win_prob[2])})
        print('')
        self.log('----------------------------------------')
        self.log('  episode      |  ' + str(episode))
        self.log('  timestep     |  ' + str(timestep))
        self.log('  reward       |  ' + str(reward))
        self.log('  1st prob     |  ' + str(win_prob[0]))
        self.log('  2st prob     |  ' + str(win_prob[1]))
        self.log('  3st prob     |  ' + str(win_prob[2]))
        self.log('----------------------------------------')
