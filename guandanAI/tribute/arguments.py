...
# Training settings
parser.add_argument('--train_model', default='base_with_tribute', type=str,
...
parser.add_argument('--base_model_path', default='models/base_model.ckpt',
                    help='base model build on')
...
parser.add_argument('--exp_epsilon', default=0, type=float,
